...
# Result accuracy list of Leave-one-out-cross validation on Delta version of aggregated eeg data:68,53,47,43
losocv.delta.aggregated = losocv(eeg_aggregated)
# Result accuracy list of Leave-one-out-cross validation on Delta version of normalized aggregated eeg data: 63,54,53,52
